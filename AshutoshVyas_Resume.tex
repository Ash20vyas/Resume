...
\item \textbf{GEU Bus Finder} (Oct-2021 - In Progress) : Building an application from my university along with my peer to track university buses and display all their information to students in real time.
