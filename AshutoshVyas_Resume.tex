...
\item \noindent \textbf{Languages} \textbf{Python} (Advanced), \textbf{JAVA} (Intermediate), \textbf{C} (Intermediate), \textbf{C++} (Intermediate), \textbf{JULIA}, \textbf{HTML}.\\
 \item \noindent\textbf{Tools and Frameworks} Azure Machine Learning, \LaTeX\\
